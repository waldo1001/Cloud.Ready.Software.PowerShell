Get-NAVCumulativeUpdateFile -versions 2017
...
Get-NAVCumulativeUpdateFile -versions 2017 -Locale fr-FR -CountryCode BE -DownloadFolder C:\_Download -ShowDownloadFolder
