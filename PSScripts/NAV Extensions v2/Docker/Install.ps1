...
$AppFile = "C:\ProgramData\NavContainerHelper\Demo\ManageAppUpgradeDemo\Cloud Ready Software GmbH_BookShelf_1.0.0.0.app"
...
Invoke-Command -Session $Session -ScriptBlock {
    ...
    Install-NAVApp -ServerInstance NAV -Name $AppInfo.Name -Version $AppInfo.Version
