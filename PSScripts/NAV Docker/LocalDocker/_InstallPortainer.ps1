...
#docker run -d -p 9000:9000 --restart always --name portainer -h portainer -v C:\ProgramData\Containers\Portainer:C:\Data portainer/portainer
docker run -d -p 9000:9000 --name portainer --restart always -v \\.\pipe\docker_engine:\\.\pipe\docker_engine -v C:\ProgramData\Containers\Portainer:C:\Data portainer/portainer
